...
public class EventSelector extends JFrame implements ActionListener
{
   ...
   private JMenuItem anniversary = new JMenuItem("Aniversary");
   ...
   private JLabel birthdayLabel = new JLabel("We have lots of ideas for memorable events");
   private JLabel otherLabel = new JLabel("otherLabel");
